...
//
//	CompilationShitImpl css;
//	Compilation c;
//
//	@Before
//	public void setUp() {
//		final StdErrSink eee = new StdErrSink();
//		c = CompilationFactory.mkCompilation(eee, new IO());
...
//		c.pipelineLogic = new PipelineLogic(css);
...
//		}
//
//		final ElLog.Verbosity verbosity = c.gitlabCIVerbosity();
...
//		}
//
//		PipelineLogic pipelineLogic = new PipelineLogic(css);
