...
//			@Override
//			public boolean matches(final BaseFunctionDef fd) {
//				final boolean b = fd.name().equals("main") && fd.getParent() == main_class;
//				return b;
//			}
//
//			@Override
//			public void apply(final Collection<EvaFunction> aGeneratedFunctions) {
//				assert aGeneratedFunctions.size() == 1;
//
//				final EvaFunction gf = aGeneratedFunctions.iterator().next();
//
//				int pc = 0;
