...
//		mod.parent = CompilationFactory.mkCompilation(new StdErrSink(), new IO());
...
//
//		final CompilationShitImpl css = new CompilationShitImpl(CompilationFactory.mkCompilation(new StdErrSink(), new IO()));
//
