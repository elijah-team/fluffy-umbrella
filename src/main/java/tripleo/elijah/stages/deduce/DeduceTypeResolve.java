...
//							final VariableStatement variableStatement = (VariableStatement) eh.getElement();
						...
						public void visitFormalArgListItem(final FormalArgListItem aFormalArgListItem) {
							...
							if (attached != null) {
							tripleo.elijah.util.Stupidity.println_err(
						...
						tripleo.elijah.util.Stupidity.println_err(String.format("** AliasStatement %s points to %s", aAliasStatement.name(), aAliasStatement.getExpression()));
						}

						@Override
						public void visitDefFunction(final DefFunctionDef aDefFunctionDef) {
						tripleo.elijah.util.Stupidity.println_err(String.format("** DefFunctionDef %s is %s", aDefFunctionDef.name(), ((StatementWrapper) aDefFunctionDef.getItems().iterator().next()).getExpr()));
						}
						...
						tripleo.elijah.util.Stupidity.println_err("158 "+anElement);
							throw new IllegalStateException();
						}
