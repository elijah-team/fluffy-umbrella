...
public class DTR_IdentExpresssion {
	...
	public DTR_IdentExpresssion(DeduceTypeResolve aDeduceTypeResolve, IdentExpression aIdentExpression, BaseTableEntry aBte) {
		deduceTypeResolve = aDeduceTypeResolve;
		identExpression = aIdentExpression;
		bte = aBte;
	}

	public void run(IElementHolder eh, GenType genType) {
