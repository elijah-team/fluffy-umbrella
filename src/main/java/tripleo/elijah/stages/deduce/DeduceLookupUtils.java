...
public enum DeduceLookupUtils {
	...
	public static @Nullable OS_Element _resolveAlias(final AliasStatement aliasStatement, @NotNull DeduceTypes2 deduceTypes2) {
		try {
...
//			s.pop();
		...
		if (t == null) {
			...
			if (t.isNull())
				return new LookupResultList(); // TODO throw here? 06/26
