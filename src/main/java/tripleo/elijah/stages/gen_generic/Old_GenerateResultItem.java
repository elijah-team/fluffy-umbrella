 ...
 */
public class Old_GenerateResultItem extends GenerateResultItem {
	public Old_GenerateResultItem(final GenerateResult.@NotNull TY aTy, final @NotNull Buffer aBuffer, final @NotNull EvaNode aNode, final @NotNull LibraryStatementPart aLsp, final @NotNull Dependency aDependency, final int aCounter) {
		super(aTy, aBuffer, aNode, aLsp, aDependency, aCounter);
	}
