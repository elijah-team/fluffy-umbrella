...
public class GI_VariableStatement implements GenerateC_Item {
	 ...
	 */
	@Contract("_, _ -> new")
	private CReference.@NotNull Reference __createReferenceForVariableStatement(final @NotNull BaseEvaFunction generatedFunction, final @Nullable String value) {
