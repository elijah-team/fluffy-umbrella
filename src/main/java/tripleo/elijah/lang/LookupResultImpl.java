...
public class LookupResultImpl {
	...
	public LookupResultImpl(final String name, final OS_Element element, final int level, final Context aContext, final ContextInfo aImportInfo) {
		this.name       = name;
	...
	public LookupResultImpl(final String name, final OS_Element element, final int level, final Context aContext) {
		this.name       = name;
		this.element    = element;
		this.level      = level;
		this.context    = aContext;
