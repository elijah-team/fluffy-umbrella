...
public class IfConditionalImpl implements StatementItem, FunctionItem, OS_Element {

	//	private final IfConditional sibling;
	private final List<IfConditionalImpl> parts = new ArrayList<IfConditionalImpl>();
...
//		this.sibling = null;
	...
	public IfConditionalImpl(final IfConditionalImpl ifExpression) {
//		this.sibling = ifExpression;
	...
	public IfConditionalImpl else_() {
		final IfConditionalImpl elsepart = new IfConditionalImpl(this);
		parts.add(elsepart);
		return elsepart;
	}

	public IfConditionalImpl elseif() {
		final @NotNull IfConditionalImpl elseifpart = new IfConditionalImpl(this);
...
//		return _items;
	...
	public List<IfConditionalImpl> getParts() {
		return parts;
	}
