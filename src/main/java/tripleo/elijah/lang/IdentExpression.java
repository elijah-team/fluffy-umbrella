...
public class IdentExpression implements IExpression, OS_Element, Resolvable, Locatable {
	...
	public void setKind(final ExpressionKind aIncrement) {
		// log and ignore
	tripleo.elijah.util.Stupidity.println_err("Trying to set ExpressionType of IdentExpression to "+aIncrement.toString());
	}
...
//		} else {
//			// NOTE wastripleo.elijah.util.Stupidity.println_err
