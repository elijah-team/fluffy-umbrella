 ...
 * @author Tripleo(sb)
 */
public class IdentExpressionImpl implements IExpression, OS_Element, Resolvable, Locatable, IdentExpression {
...
//		return null;
	...
	@Contract("_ -> new")
	public static @NotNull IdentExpressionImpl forString(final String string) {
