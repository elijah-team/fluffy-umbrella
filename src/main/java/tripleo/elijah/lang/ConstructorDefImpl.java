 ...
 */
public class ConstructorDefImpl extends BaseFunctionDef {
	public static final IdentExpression emptyConstructorName = Helpers.string_to_ident("<>");

	// TODO override name() ??
	public static final ConstructorDefImpl defaultVirtualCtor = new ConstructorDefImpl(null, null, null);
