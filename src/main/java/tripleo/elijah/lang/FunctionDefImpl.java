...
public class FunctionDefImpl extends BaseFunctionDef implements Documentable, ClassItem, OS_Element2 {
	...
	public FunctionDefImpl(final OS_Element element, final Context context) {
		parent = element;
