...
//				tripleo.elijah.util.Stupidity.println_out("102 "+item);
...
//				tripleo.elijah.util.Stupidity.println_out("1001 "+tn);
				final NormalTypeName tn = (NormalTypeName)tn1;
				final OS_Element best;
				final LookupResultList tnl = tn.getContext().lookup(tn.getName());
//	    		tripleo.elijah.util.Stupidity.println_out("1002 "+tnl.results());
...
//				tripleo.elijah.util.Stupidity.println_out("1003 "+name+" "+Result.results());
