...
public class MatchContext extends Context {
	...
	@Override
	public LookupResultList lookup(final String name, final int level, final LookupResultList Result, final @NotNull List<Context> alreadySearched, final boolean one) {
