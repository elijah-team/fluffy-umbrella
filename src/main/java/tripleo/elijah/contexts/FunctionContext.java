...
//				tripleo.elijah.util.Stupidity.println_out("[FunctionContext#lookup] VariableSequence "+item);
...
//		tripleo.elijah.util.Stupidity.println_out("[#introduceVariable] "+variable);
...
//		tripleo.elijah.util.Stupidity.println_out("[#introduceFunction] "+expression);
