...
public class CaseContext extends Context {
	...
	@Override
	public LookupResultListImpl lookup(final String name, final int level, final LookupResultListImpl Result, final List<Context> alreadySearched, final boolean one) {
