...
//			}
//		tripleo.elijah.util.Stupidity.println_err("101 Searching "+items.toString()+" for "+name);
			//
			if (!(item instanceof ClassStatement) &&
...
//			tripleo.elijah.util.Stupidity.println_err(103);
...
//	tripleo.elijah.util.Stupidity.println_err("2003 "+carrier.getItems());
...
//	tripleo.elijah.util.Stupidity.println_err("2002 "+importStatement.importList());
		for (Qualident importStatementItem : importStatement.parts()) {
//		tripleo.elijah.util.Stupidity.println_err("2005 "+importStatementItem);
...
//				tripleo.elijah.util.Stupidity.println_err("4000 "+element);
