...
/**
 * @author johnthebaptist
 */
public class EG_SingleStatement implements EG_Statement {
    
    
/*
    final private GraphBuilderContext gbc = new GraphBuilderContext() {
        @Override
        ...
        @Override
        public boolean intrinsify(BytecodeProvider bytecodeProvider, ResolvedJavaMethod targetMethod, ResolvedJavaMethod substitute, InvocationPlugin.Receiver receiver, ValueNode[] argsIncludingReceiver) {
            throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
        }
