...
public class DefaultParser implements CommandLineParser {
	 ...
	 */
	private void handleToken(final CompilerInput ci) throws ParseException {
	...
	private void handleUnknownToken(final CompilerInput ci) throws ParseException {
	...
	@Override
	public CommandLine parse(Options options, @NotNull List<CompilerInput> aInputs) throws ParseException {
