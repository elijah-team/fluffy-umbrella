...
//				tripleo.elijah.util.Stupidity.println_out(ctc.toString());
//			} catch (Exception e) {
//				e.printStackTrace();
//			}
//		else {
...
//				}
//				tripleo.elijah.util.Stupidity.println_out(String.format("%s vv%s;", theType, ii.name));
//
//			}
...
//		} else {
//			tripleo.elijah.util.Stupidity.println_out(element);
//
//		}
//	}
//
